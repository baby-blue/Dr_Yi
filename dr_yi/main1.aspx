<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main1.aspx.cs" StylesheetTheme="yi_css" Inherits="dr_yi.main1" %>
...
<body style="margin: 0; padding: 0; overflow: hidden">
    ...
    <script>
        var ifm = document.getElementById("ciframe");
        ifm.height = document.documentElement.clientHeight - 82
    </script>
</body>
</html>
